 ...
 *
 *          Custom monitor EDID file loader. (Video2 version)
 *
 ...
 *          Copyright 2025 Connor Hyde (stdint'ified everything)
 */
#include <stdbool.h>
#include <stdint.h>
#include <stdio.h>
...
#define EDID_TEMPBUF_SIZE   64

static size_t
read_block(FILE *fp, uint8_t *buf)
{
    char    temp[EDID_TEMPBUF_SIZE];
    size_t  read = 0;
